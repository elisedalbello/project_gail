...
class CreateTbQuestoes < ActiveRecord::Migration
  ...
  def up
    execute <<-SQL
      ...
      (1, 6, 'Com qual idade ocorreu a sua primeira mentruação?', true),
      (1, 7, 'Com que idade você teve seu primeiro filho?', true),
      (1, 8, 'Você tem parentes com câncer de ovário?', true),
